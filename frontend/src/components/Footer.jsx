...
const Footer = () => {
  return (
    <div className='md:mx-10'>
      ...
      <div>
        <hr />
        <p className='py-5 text-sm text-center'>Copyright 2025 @ QuickCare.com - All Right Reserved.</p>
      </div>
